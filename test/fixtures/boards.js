...
const BoardFixture = {
  ...
  '12x12': {
    'incompleted': [
      [ 0, 4,   0,  5,  0, 0,  0,  0,  0, 6,  7, 0],
      [ 6, 11,  0, 10,  1, 0,  9,  0,  0, 0,  8, 2],
      [12,  0,  0,  0,  0, 0, 10, 11,  0, 0,  0, 0],
      [ 0,  0,  0,  8, 11, 0,  0,  0,  9, 0,  5, 6],
      [ 0,  0,  2,  0,  0, 9,  8,  0, 11, 0, 12, 0],
      [ 0,  6, 11,  0,  7, 0,  0,  4,  0, 0,  0, 0],
      [ 0,  0,  0,  0, 12, 0,  0,  7,  0, 5,  6, 0],
      [ 0,  5,  0,  7,  0, 6,  4,  0,  0, 1,  0, 0],
      [ 2, 12,  0,  1,  0, 0,  0, 10,  7, 0,  0, 0],
      [ 0,  0,  0,  0,  2, 3,  0,  0,  0, 0,  0, 8],
      [11,  7,  0,  0,  0, 8,  0,  9,  6, 0,  3, 1],
      [ 0,  3,  1,  0,  0, 0,  0,  0,  5, 0,  9, 0]
    ]
  },
  '16x16': {
    'completed': [
